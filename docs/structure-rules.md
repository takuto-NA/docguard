...
In this repository: both Phase 3 flags stay off in the default `pyproject.toml`. If enabled against the current documentation scope, readiness tests expect 0 mixed-role candidates and 0 heading-level skips. See [docs/dogfood.md](dogfood.md).
